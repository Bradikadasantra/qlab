                        ...
                        <nav>
                            <div class="nav nav-tabs mt-5" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><i class="fas fa-paperclip"></i> Approval Hasil Uji
                                    <?php 
                                        $notif = notif_navbar(array('id_bidang'=> $id_bidang), "(status = '8' AND status_sampel != '3' AND status_sampel != '6')", 'status_tinjauan_mt != 4');
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo status_tinjauan(array('order.no_order'=> $baris->no_order), "(id_bidang = '$id_bidang' AND status_sampel != '3' AND status_sampel != '6')", "(status_tinjauan_mt = '2' OR status_tinjauan_mt = '3')") ?></td>
