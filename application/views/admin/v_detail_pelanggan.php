<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo base_url('c_admin/update_pelanggan'); ?>" method="post" enctype='multipart/form-data'>
                ...
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="instansi" id="instansi" value="<?php echo $baris['instansi']; ?>">
                        </div>

                        <div class="form-group">
                            <label for="alamat_instansi">Alamat Instansi</label>
                            <input type="text" class="form-control" name="alamat_instansi" id="alamat_instansi" value="<?php echo $baris['alamat_instansi']; ?>">
                        </div>
                    </div>
                                ...
                                <?php
                                  if($baris['aktif'] == '1'){
                                    echo "<option value =\"1\" selected > Aktif</option>";
                                        ...
                                        echo "<option value=\"1\">Aktifk</option>";
                                        }
                                if($baris['aktif'] == '0'){
