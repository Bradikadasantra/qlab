    ...
    <?php foreach($dokumen_prosedur as $baris):?>
             <div class="col-md-12">
                <form action="<?php echo base_url('c_dokumen/update_dokumen_prosedur'); ?>" enctype="multipart/form-data" method="post">
                    <div class="row">
                        <div class="col-md">
                            <input type="hidden" name="id_dp" value="<?php echo $baris['id_dp'] ?>"/>
                                    ...
                                    <div> 
                                        <?php if($baris['nama_dokumen'] == 'Default.pdf' or $baris['nama_dokumen']  == null ){ ?>
                                            <img src="<?php echo base_url('assets/img/pdf.png') ?>" style="height:100px; width:100px; "/>
                                                ...
                                                ?>
                                            <embed src ="<?php echo base_url('dokumen_prosedur/'.$baris['nama_dokumen']) ?>" style="height:150px; width:300px;">
                                            <?php
                                                    }
