<div class="container-fluid">
	...
	?>
            <div class="card">
                <div class="card-body">
                        <small><i class="fas fa-list fa-fw"></i> Dokumen <span class="fas fa-chevron-right mx-1"></span> Daftar Dokumen Instruksi Kerja</small><br>
                        <?php
                   ...
                   <div class="card">
                        <div class="card-header bg-primary">
                            <h6 class="text-light">Daftar Dokumen Instruksi Kerja</h6>
                        </div>
                        <div class="card-body">
                            <table class="table table-hover table-sm" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align:center">     
                                        ...
                                        <td><a href="<?php echo base_url('ViewerJS/#../dokumen_instruksi_kerja/'.$baris['nama_dokumen'])?>"><img src="<?php echo base_url('assets/img/pdf.png')?>" style="width:20px; height:20px"></a></td>
                                        <td><a href='#myModal' class='btn btn-primary btn-sm' id='custId' data-toggle='modal' data-id="<?php echo $baris['id_dik']; ?>"><i class="fas fa-edit fa-sm"></i></a>
                                        <?php
                                        $hak_akses = $this->session->userdata('hak_akses');
                                        if ($hak_akses == "admin_sampel") { ?>
                                        <a href="#konfirmasi_hapus" class='btn btn-danger btn-sm' data-toggle='modal' data-id="<?php echo base_url('c_dokumen/hapus_dokumen_instruksi_kerja/'.$baris['id_dik'])?>"><i class="fas fa-trash fa-sm"></i></a></td>
                                        <?php } ?>
                                    </tr>
                                    <?php endforeach ?>
                                </tbody>
...
<div class="modal fade bd-example-modal-lg"  id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	$(document).ready(function(){
        $('#myModal').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
				url : "<?php echo base_url('c_dokumen/detail_dokumen_instruksi_kerja')?>",
				 data :  'rowid='+ rowid,
