        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-11">
                    <div class="card">
                        <div class="card-body">
                            <small><i class="fas fa-file-pdf fa-fw fa-sm"></i>  Dokumen <span class="fas fa-chevron-right fa-fw mx-1"></span> Detail Dokumen</small>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-9">
                                    ...
                                    <a href="#myModal" data-toggle="modal" data-id="<?php echo $no_dokumen; ?>" class="btn btn-info btn-sm" data-id="<?php echo $no_dokumen; ?>"><i class="fas fa-edit fa-fw fa-sm"></i> Edit </a>
                                    <a href="#konfirmasi_hapus" class='btn btn-danger btn-sm' data-toggle='modal' data-id="<?php echo base_url('c_dokumen/hapus_dokumen/'.$no_dokumen)?>"><i class="fas fa-trash fa-sm"></i> Hapus</a></td>
                                    <?php } ?>
                                </div>
                            </div>
                           <hr class="mt-2">
